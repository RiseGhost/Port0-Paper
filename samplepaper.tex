...
O aprendizado conseguido através de experimentação por tentativa e erro, é uma estratégia de aprendizado ativa e exploratória na qual o individuo testa hispóteses em tempo real para verificar quais ações produzem resultados eficazes e quais levam à falha \cite{villareale2020}.

Esta forma de aprendizado pode se relacionar com outras técnicas.

Técnicas como o trial and error, por exemplo, é um processo em que os alunos utilizam a repetição sistemática de missões ou tarefas até atingirem o sucesso ou a pontuação máxima, permitindo-lhes compreender conceitos complexos através da experiência direta das suas próprias falhas \cite{Marques2021} \cite{Sari2025}.
