...
Serious games and simulation-based games provide players with interactive experiences that incorporate educational content. However, studies such as *Game-Based Learning with Computers: Learning, Simulations* \cite{Martens2008} demonstrate that even games developed exclusively for entertainment require players to acquire new knowledge, develop complex skills, and devise effective strategies in order to progress through levels and overcome challenges.

Similarly, research such as *Video Games and Indirect Learning* by Monica Miller \cite{Monica_Miller} suggests that the content of video games can also facilitate indirect learning, that is, learning that occurs without the game being explicitly designed for educational purposes.
